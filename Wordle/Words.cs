...
* This class is the Model of my MVC. this does all the errorchecking and random word generating.
 It first picks a random number out of the number of indexes in an array and then find that word in 
 the arry. Then takes the user guess and checks with the random word to see witch letters they got 
 correct or misplaces.
*/
